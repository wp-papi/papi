...
/**
 * Network store implementation of Papi meta store.
 */
class Papi_Network_Store extends Papi_Core_Meta_Store {
	...
	public function __construct( $id = 0 ) {
		// Network don't have a id so set it to zero.
		$this->id = 0;
	}
	...
	public function get_property( $slug, $child_slug = '' ) {
		...
		if ( $entry_type instanceof Papi_Network_Type === false ) {
			return;
		}

...
With this version we changed how `remove` method works, it's removed from the page type class and will work inside `register` method anymore. This is because we removed one of the calls to `register` method.
